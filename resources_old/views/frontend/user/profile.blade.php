            ...
            <div class="dashboard-content">
                ...
                <div style="background: white; padding: 40px; border-radius: 20px; box-shadow: var(--shadow-sm);">
                    <form action="{{ route('user.profile.update') }}" method="POST">
                        ...
                        <h3 style="margin-bottom: 30px; border-top: 1px solid var(--gray-100); padding-top: 30px;">Billing Address</h3>
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 30px;">
                            <div class="form-group-checkout">
                        ...
                        <h3 style="margin-bottom: 30px; border-top: 1px solid var(--gray-100); padding-top: 30px;">Change Password</h3>
