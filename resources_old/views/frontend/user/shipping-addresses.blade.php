        ...
        <div style="display: grid; grid-template-columns: 280px 1fr; gap: 40px;">
            ...
            <div class="dashboard-content">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 40px;">
                    ...
                    <div style="background: white; padding: 30px; border-radius: 20px; box-shadow: var(--shadow-sm); position: relative;">
                    ...
                    <div style="background: white; border: 2px dashed var(--gray-200); padding: 30px; border-radius: 20px; display: flex; flex-direction: column; align-items: center; justify-content: center; min-height: 200px;">
